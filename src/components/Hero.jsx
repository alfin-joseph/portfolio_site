      ...
      <div className={`container ${styles.heroContainer}`}>
        ...
        >
          ...
          <p className={styles.description}>
            I'm a Results-driven Full Stack Developer with 3 years of experience specializing in Python, Django, FastAPI, and React.js. I'm focused on building accessible, human-centered products and internal automation platforms.
          </p>
          
          <div className={styles.actions}>
            <a href="https://github.com/alfin-joseph" target="_blank" rel="noreferrer" className={styles.socialLink}><FiGithub /></a>
            <a href="mailto:alfinjoseph934@gmail.com" className={styles.socialLink}><FiLinkedin /></a>
